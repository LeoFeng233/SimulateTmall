            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pisSingle}" var="productImage">
                            <tr>
                                <td>${productImage.id}</td>
                                <td>
                                    <a title="点击查看原图" href="resources/img/productSingle/${productImage.id}.jpg"><img
                                            height="50px"
                                            src="resources/img/productSingle/${productImage.id}.jpg"></a>
                                </td>
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pisDetail}" var="productImage">
                            <tr>
                                <td>${productImage.id}</td>
                                <td>
                                    <a title="点击查看原图" href="resources/img/productDetail/${productImage.id}.jpg"><img
                                            height="50px"
                                            src="resources/img/productDetail/${productImage.id}.jpg"></a>
                                </td>
                                <td><a deleteLink="true"
                                       href="admin_productImage_delete?id=${productImage.id}"><span
                                        class="     glyphicon glyphicon-trash"></span></a></td>
