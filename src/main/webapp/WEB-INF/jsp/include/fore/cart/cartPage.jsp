    ...
    $(function () {
        ...
        $("img.cartProductItemIfSelected").click(function () {
            ...
            if ("selectit" == selectit) {
                $(this).attr("src", "resources/img/site/cartNotSelected.png");
                $(this).attr("selectit", "false")
                $(this).parents("tr.cartProductItemTR").css("background-color", "#fff");
            }
            else {
                $(this).attr("src", "resources/img/site/cartSelected.png");
        ...
        $("img.selectAllItem").click(function () {
            var selectit = $(this).attr("selectit")
            if ("selectit" == selectit) {
                $("img.selectAllItem").attr("src", "resources/img/site/cartNotSelected.png");
                ...
                $("img.selectAllItem").attr("src", "resources/img/site/cartSelected.png");
                ...
                <tr oiid="${orderItem.id}" class="cartProductItemTR">
                    <td>
                        <img selectit="false" oiid="${orderItem.id}" class="cartProductItemIfSelected"
                             src="resources/img/site/cartNotSelected.png">
                        <a style="display:none" href="#nowhere"><img src="resources/img/site/cartSelected.png"></a>
                        <img class="cartProductImg"
                             src="resources/img/productSingle_middle/${orderItem.product.firstProductImage.id}.jpg">
                    </td>
                    <td>
