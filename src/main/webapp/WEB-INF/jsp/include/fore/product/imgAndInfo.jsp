...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="resources/img/productSingle/${product.firstProductImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${product.productSingleImages}" var="productImage">
                <img src="resources/img/productSingle_small/${productImage.id}.jpg"
                     bigImageURL="resources/img/productSingle/${productImage.id}.jpg"
                     class="smallImage">
            </c:forEach>
        </div>
